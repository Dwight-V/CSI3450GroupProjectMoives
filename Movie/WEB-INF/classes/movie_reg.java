...
public class movie_reg extends HttpServlet { //note how the filename matches the classname
  // Use a prepared statement to store a student into the database
  private PreparedStatement pstmt;

  /** Initialize global variables */
  public void init() throws ServletException { //this is a method definition
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse
    ...
    String m_id = request.getParameter("m_id"); //note how the String class OBJECT is the same as the name in the various html forms
  ...
  private void initializeJdbc() {
    ...
    String url = "jdbc:oracle:thin:@127.0.0.1:1521:orcl"; //the oracle driver's url - the source locator. port 1521. orcl is the default database name, so you will need to change that if you named it different. 127.0.0.1 is localhost.
    String user = "project"; //this is the username for your database user - for me, C##CSI3450
    String password = "project"; //this is the password for your database user - for me, walpaCinna_1

      // Connect to the sample database
      Connection conn = DriverManager.getConnection //the method getConnection() is defined within sql.
        (url, user, password);

      // Create a Statement - this is where the sql code is!!!!!!!!! the ? marks are the values taken from the html form.
  ...
  private void storeStudent(String m_id, String m_title,
    ...
    pstmt.setString(1, m_id); //note how the right parameter is the same as the name in the various html forms
