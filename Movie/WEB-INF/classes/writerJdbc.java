...
public class writerJdbc extends HttpServlet 
{
    ...
    {        
		...
		//Queries the database for the Writer table's entries
		query = "select writ_ID, writ_contr, p_ID, m_ID from writer";
		
		out.println("<html><head><title>Writer Table Report</title>");	 
		out.println("</head><body>");
		
		out.print( "<br /><b><center><font color=\"RED\"><H2>Writer Table Report</H2></font>");
        out.println( "</center><br />" );

       	try 
		{ 
			//Executes SQL query to show all of the Writer table's entries
		...
		//Setup for the table to be presented. Writer table attribute names are the names of the report table's columns.
		out.println("<center><table border=\"1\">"); 
		out.println("<tr BGCOLOR=\"#cccccc\">");
        out.println("<td align = \"justify\"><font face =\"times new roman\"  size=\"4pt\">Writer ID</td>");
