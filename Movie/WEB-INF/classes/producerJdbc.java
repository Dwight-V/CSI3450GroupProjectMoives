...
public class producerJdbc extends HttpServlet 
{
    ...
    {        
		...
		//Queries the database for the Producer table's entries
		query = "select * from producer";
		
		out.println("<html><head><title>Producer Table Report</title>");	 
		out.println("</head><body>");
		
		out.print( "<br /><b><center><font color=\"RED\"><H2>Producer Table Report</H2></font>");
        out.println( "</center><br />" );

       	try 
		{ 
			//Executes SQL query to show all of the Producer table's entries
        ...
        out.println("<td align = \"justify\"><font face =\"times new roman\"  size=\"4pt\">Producer ID</td>");
