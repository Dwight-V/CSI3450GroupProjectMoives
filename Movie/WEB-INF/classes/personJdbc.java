...
public class personJdbc extends HttpServlet 
{
    ...
    {        
		...
		//Queries the database for the Person table's entries
		query = "select p_id, p_lastName, p_firstName, p_pay from person";
		...
		out.println("<td align = \"justify\"><font face =\"times new roman\"  size=\"4pt\">Pay</td>");
        out.println("</tr>");
