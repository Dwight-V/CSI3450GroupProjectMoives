...
public class theatre_del extends HttpServlet 
{
    ...
    {        
		...
		{			
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@127.0.0.1:1521:eolson", "c##project", "project");
		...
		query = "delete from theatre where t_id = '"+t_id+"'";
		
		out.println("<html><head><title>Theatre has been deleted</title>");	 
       ...
       // out.println("<td align = \"justify\"><font face =\"times new roman\"  size=\"4pt\">theatretitle</td>");
        out.println("</tr>");
		try 
		{ 
            while(result.next()) 
