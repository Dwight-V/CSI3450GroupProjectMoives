...
public class directorJdbc extends HttpServlet 
{
    ...
    {        
		...
		//Queries the database for the Director table's entries
		query = "select * from director";
		
		out.println("<html><head><title>Director Table Report</title>");	 
		out.println("</head><body>");
		
		out.print( "<br /><b><center><font color=\"RED\"><H2>Director Table Report</H2></font>");
		...
		//Setup for the table to be presented. Director table attribute names are the names of the report table's columns.
		out.println("<center><table border=\"1\">"); 
		out.println("<tr BGCOLOR=\"#cccccc\">");
        out.println("<td align = \"justify\"><font face =\"times new roman\"  size=\"4pt\">Director ID</td>");
		out.println("<td align = \"justify\"><font face =\"times new roman\"  size=\"4pt\">Position</td>");
