...
public class actressJdbc extends HttpServlet 
{
    ...
    {        
		...
		out.print( "<br /><b><center><font color=\"RED\"><H2>Actress Table Report</H2></font>");
        out.println( "</center><br />" );

       	try 
		{ 
			//Executes SQL query to show all of the Actress table's entries
		...
		//Setup for the table to be presented. Actress table attribute names are the names of the report table's columns.
